...
<head>
    ...
    <title>500 - Server Error | Space Xplorer</title>
    ...
    <div class="max-w-4xl mx-auto px-4 font-mono">
        ...
        <div class="mb-6">
            <div class="text-sm text-space-primary dark:text-space-primary mb-2">
                <span class="text-gray-500 dark:text-gray-500">SYSTEM@SPACE-XPLORER:~$</span> <span class="text-space-primary dark:text-space-primary">system_status</span>
            </div>
