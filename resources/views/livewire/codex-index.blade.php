    ...
    <div class="font-mono codex-scanlines">
        ...
        <div class="flex gap-8">
            ...
            <main class="flex-1">
                                ...
                                >
                                    ...
                                    <div class="p-4">
                                        ...
                                        @if ($recent->discoveredBy)
                                            <p class="mb-1 font-mono text-sm text-gray-400">
                                                [AGENT] {{ \Illuminate\Support\Str::limit($recent->discoveredBy->name, 20) }}
                                            </p>
                                        @endif
                                        <p class="font-mono text-xs text-gray-500">
                                            [LOG] {{ $recent->created_at->diffForHumans() }}
                                        </p>
                                    </div>
                                </a>
                            @endforeach
                ...
                <div class="mb-8">
                    <div class="relative">
                        <input
                            ...
                            placeholder="[SEARCH] Rechercher dans les archives..."
                            class="font-mono w-full rounded-lg border border-border-dark bg-surface-dark px-4 py-3 pl-10 text-white placeholder-gray-500 focus:border-space-primary focus:outline-none focus:ring-2 focus:ring-space-primary"
                        />
                        @if (!empty($search))
                            <button
                                wire:click="clearSearch"
                                class="absolute right-3 top-1/2 -translate-y-1/2 text-gray-400 hover:text-space-primary transition-colors"
                                    ...
                                    <div class="flex items-center justify-between">
                                        <div class="flex-1">
                                            ...
                                            @if ($entry->discoveredBy)
                                                <p class="mt-2 font-mono text-sm text-gray-400">
                                                    [AGENT] {{ $entry->discoveredBy->name }} | [DATE] {{ $entry->created_at->format('d/m/Y') }}
                                                </p>
                                            @endif
                                        </div>
                                    </div>
                ...
                <!-- Quick Access -->
                <div class="mb-8">
                    <h2 class="mb-4 font-sans text-2xl font-semibold text-space-primary text-glow-subtle dark:text-white">[SYSTEM MODULES]</h2>
                    <div class="grid gap-4 md:grid-cols-3">
                        ...
                        >
                            <div class="mb-2 flex items-center">
                                ...
                                <h3 class="font-sans text-lg font-semibold text-white group-hover:text-space-primary transition-colors">[MODULE] Catalogue Planètes</h3>
                            </div>
                            <p class="font-mono text-sm text-gray-400">
                                Accès aux archives complètes des planètes cataloguées
                            </p>
                        </a>
                        <a
                        ...
                        >
                            <div class="mb-2 flex items-center">
                                ...
                                <h3 class="font-sans text-lg font-semibold text-white group-hover:text-space-accent transition-colors">[MODULE] Cartographie Stellaire</h3>
                            </div>
                            <p class="font-mono text-sm text-gray-400">
                                Consultation des systèmes stellaires cartographiés
                            </p>
                        </a>
                        <a
                        ...
                        >
                            <div class="mb-2 flex items-center">
                                ...
                                <h3 class="font-sans text-lg font-semibold text-white group-hover:text-space-secondary transition-colors">[MODULE] Distinctions</h3>
                            </div>
                            <p class="font-mono text-sm text-gray-400">
                                Tableau d'honneur du personnel Stellar
                            </p>
                        </a>
                    </div>
                </div>
