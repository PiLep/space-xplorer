...
Format : `REPORT-{YYYY-MM-DD}-{issue-number}-{titre}.md`
...
Les rapports sont utilisés pour :
- Identifier les points d'amélioration du workflow
...
- [monitor-workflow.md](../prompts/monitor-workflow.md) : Guide pour créer des rapports
- [MANAGER.md](../agents/MANAGER.md) : Description de l'agent Taylor
